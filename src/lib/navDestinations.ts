...
export const NAV_DESTINATIONS: NavDestination[] = [
  ...
  { to: "/trades", label: "My Trades", icon: ArrowLeftRight, blurb: "Every deal you're working on" },
  { to: "/compliance", label: "Compliance", icon: ShieldCheck, blurb: "Your KYB and governance record" },
