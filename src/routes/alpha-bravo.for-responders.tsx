...
export const Route = createFileRoute("/alpha-bravo/for-responders")({
  head: () => ({
    meta: [{ title: "For Responders — Izenzo Alpha-Bravo" }],
  }),
  component: ForResponders,
});
      ...
      <section className="border-t border-border">
        <div className="mx-auto max-w-3xl px-5 py-16 text-center">
          ...
          <p className="mt-6 text-sm text-muted-foreground">
            Are you a Bidder?{" "}
            <Link to="/alpha-bravo/for-bidders" className="font-medium text-primary hover:underline">
